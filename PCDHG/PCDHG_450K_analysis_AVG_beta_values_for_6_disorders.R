...
PD <- positions.annot.df[grep("PCDHG", positions.annot.df$SYMBOL), ]
...
###################################################################################################################
#make average beta value for each pcdhg gene promoter
...
refGenes <- UcscTrack(genome = "hg19", chromosome = "chr5",
                      ...
                      stacking = "dense", name = "PCDHG", background.panel = "white",
...
Heatmap(combo2_matrix, name = "beta", column_title = "Heatmap according to 248 CpGs located in the promotoer regions(2500-TSS+2500) of PCDHGs", show_row_names = FALSE)
